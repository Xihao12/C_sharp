    ...
    public partial class RegisterForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "" && textBox2.Text != "" && textBox3.Text != "")
            {
                ...
                //构造SqlCommand对象
                string sql = "select password from bicycle_users where uname='" + textBox1.Text + "'";
                SqlCommand cmd = new SqlCommand(sql, myConn);
                string sql1 = "select count(*) from bicycle_users";
                ...
                string insertStr = "insert into bicycle_users (uno,uname, password) values ('" + uno+"', '"+ textBox1.Text + "', '" + textBox2.Text + "')";
